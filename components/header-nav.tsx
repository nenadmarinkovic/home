...
export function HeaderNav() {
  ...
  const navClass =
    "hidden flex-row items-center gap-5 text-xs font-medium uppercase tracking-[0.06em] text-zinc-600 md:flex dark:text-zinc-400";
    ...
    <nav className={navClass}>
      ...
      {authed && (
        <button
          ...
          className={cn(
            linkClass,
            "cursor-pointer text-xs font-medium uppercase tracking-[0.06em] disabled:opacity-50",
          )}
        >
