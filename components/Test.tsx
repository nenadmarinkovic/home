...
function Test() {
  const boxItems = [
    {
      icon: (
        <svg
          className={boxStyles.boxItemMainIcon}
          height="16"
      ...
      text: `Performance testing fine-tunes load times and overall user experience.`,
    },
    {
      icon: (
        <svg
      ...
      text: `Testing across diverse devices and browsers guarantees seamless interaction.`,
    },
    {
      icon: (
        <svg
      ...
      text: `Usability testing collects feedback to enhance intuitive design and navigation.`,
    },
  ];
  ...
  return (
    <Container>
      <div
        className={`${processStyles.processContainer} ${boxStyles.boxSecond}`}
      >
        <div className={processStyles.chartContainer}>
          <div className={boxStyles.boxCharts}>
            <div className={boxStyles.boxChartItems}>
              <TestChart
                maxValue={99}
                circleValue={0.97}
        ...
        <Box
          title="Test"
          boxColor="green"
          headerText="Testing isn't just about finding bugs — it's about making sure your product works like a charm for your customers, keeping them happy and satisfied."
          mainTitle="Rigorous testing in every stage of the project lifecycle"
          boxItems={boxItems}
        />
        <div className={processStyles.processDots}></div>
      </div>
    </Container>
  );
}
