  ...
  return (
    <div className={styles.productsItemContainer}>
      <div className={styles.productsItem}>
        ...
        <span className={styles.productsItemText}>{text}</span>
      </div>
      ...
      <div className={styles.products}>
        ...
        <div className={styles.productsItems}>
          ...
          <ProductItem
            ...
            text="Intuitive user interfaces that provide a seamless experience for the end user."
            icon={
              <svg
                height="16"
                strokeLinejoin="round"
