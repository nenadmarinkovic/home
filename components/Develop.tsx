  ...
  const boxItems = [
    {
      ...
      text: `It is ${currentYear} and websites need to be fast, reliable and with lag free interaction as a top priority.`,
    },
    {
      icon: (
        <svg
      ...
      text: `Well-developed websites and applications rank higher in search results (SEO).`,
    },
    {
      icon: (
        <svg
      ...
      text: `Websites should be accessibility, responsive, fully functional and user-friendly.`,
    },
  ];
