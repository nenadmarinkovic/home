  ...
  const boxItems = [
    {
      ...
      text: `Deployment is crucial in modern web development for timely updates and adaptation.`,
    },
    {
      icon: (
        <svg
      ...
      text: `Optimized deployments lead to improved performance, ensuring swift load times.`,
    },
    {
      icon: (
        <svg
      ...
      text: `A well-executed deployment guarantees that your web application remains stable and reliable.`,
    },
  ];
  return (
    <Container>
      <div className={processStyles.processContainer}>
        <Box
          title="Deploy"
          boxColor="orange"
          headerText="With automated deployments, your customers can trust that your product is always up-to-date and secure, enhancing their confidence in your brand."
          mainTitle="Smooth deployment process with continuous monitoring"
          boxItems={boxItems}
        />
